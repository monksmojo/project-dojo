...
<head>
		...
		<!-- Theme CSS	============================================ -->
		<link rel="stylesheet" href="<?php echo BASE_URL;?>js/arcticmodal/jquery.arcticmodal.css"/>
		<link rel="stylesheet" href="<?php echo BASE_URL;?>js/owlcarousel/owl.carousel.css"/>
		<link rel="stylesheet" href="<?php echo BASE_URL;?>js/colorpicker/colorpicker.css"/>
...
<!-- - - - - - - - - - - - - - end Styleswitcher - - - - - - - - - - - - - - - - -->
     ...
     <?php include'../inc/header.php' ;?>
		...
		<script src="<?php echo BASE_URL;?>js/arcticmodal/jquery.arcticmodal.js"></script>
		<script src="<?php echo BASE_URL;?>js/jquery.countdown.plugin.min.js"></script>
		...
		<!-- Theme files
		============================================ -->
	<script src="<?php echo BASE_URL;?>js/theme.styleswitcher.js"></script>
